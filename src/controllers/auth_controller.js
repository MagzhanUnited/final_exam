    ...
    if (err) {
      ...
      if (foundUser === null) {
        res.render("login", {
          ...
          alert: showAlert(
            "alert-danger",
            "username tidak terdaftar, silahkan coba lagi."
          ),
        });
      } else {
        req.login(user, (err) => {
    ...
    if (err) {
      ...
      if (foundUser === null) {
        ...
        if (regPassword === regConfirm_password) {
          // jika password cocok dengan confirm_password
          User.register(
            {
          ...
          res.render("register", {
            ...
            alert: showAlert(
              "alert-danger",
              "password tidak cocok dengan confirm_password!"
            ),
          });
        }
      } else {
        res.render("register", {
          ...
          alert: showAlert(
            "alert-danger",
            "sudah pernah ada akun dengan username tersebut!"
          ),
        });
      }
    }
